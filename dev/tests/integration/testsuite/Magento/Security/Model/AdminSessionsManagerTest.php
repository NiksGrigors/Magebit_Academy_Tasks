...
class AdminSessionsManagerTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Collection.php getter with filters populated for testLogoutOtherUserSessions() method
     *
    ...
    /**
     * Collection.php getter with filters populated for testCleanExpiredSessions() method
     *
     * @param AdminSessionInfo $session
     * @return ResourceModel\AdminSessionInfo\Collection
     */
