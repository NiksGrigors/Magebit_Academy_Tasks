<?php
namespace Hyva\Widgets\Block\Widgets\MultiField;

/**
 * Interceptor class for @see \Hyva\Widgets\Block\Widgets\MultiField
 */
class Interceptor extends \Hyva\Widgets\Block\Widgets\MultiField implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Widget\Helper\Conditions $conditionsHelper, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $conditionsHelper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMultiFieldSteps');
        return $pluginInfo ? $this->___callPlugins('getMultiFieldSteps', func_get_args(), $pluginInfo) : parent::getMultiFieldSteps();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageUrlByPath');
        return $pluginInfo ? $this->___callPlugins('getImageUrlByPath', func_get_args(), $pluginInfo) : parent::getImageUrlByPath($path);
    }
    ...
    public function getImageUrl(string $imageField = 'image') : string
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getImageUrl', func_get_args(), $pluginInfo) : parent::getImageUrl($imageField);
    }
    ...
    public function getPreparedUrl($urlLink) : string
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getPreparedUrl', func_get_args(), $pluginInfo) : parent::getPreparedUrl($urlLink);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPreparedDescription');
        return $pluginInfo ? $this->___callPlugins('getPreparedDescription', func_get_args(), $pluginInfo) : parent::getPreparedDescription($descriptionField);
    }
