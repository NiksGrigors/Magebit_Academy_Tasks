...
class Interceptor extends \Magento\Ui\Block\Logger implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function isLoggingEnabled()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('isLoggingEnabled', func_get_args(), $pluginInfo) : parent::isLoggingEnabled();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSessionStorageKey');
        return $pluginInfo ? $this->___callPlugins('getSessionStorageKey', func_get_args(), $pluginInfo) : parent::getSessionStorageKey();
    }
