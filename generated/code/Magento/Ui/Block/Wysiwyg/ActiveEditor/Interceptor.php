...
class Interceptor extends \Magento\Ui\Block\Wysiwyg\ActiveEditor implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWysiwygAdapterPath');
        return $pluginInfo ? $this->___callPlugins('getWysiwygAdapterPath', func_get_args(), $pluginInfo) : parent::getWysiwygAdapterPath();
    }
