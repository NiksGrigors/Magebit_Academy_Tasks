...
class Interceptor extends \Magento\Ui\Component\Control\Button implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributesHtml');
        return $pluginInfo ? $this->___callPlugins('getAttributesHtml', func_get_args(), $pluginInfo) : parent::getAttributesHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOnClick');
        return $pluginInfo ? $this->___callPlugins('getOnClick', func_get_args(), $pluginInfo) : parent::getOnClick();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAfterHtml');
        return $pluginInfo ? $this->___callPlugins('getAfterHtml', func_get_args(), $pluginInfo) : parent::getAfterHtml();
    }
