...
class Interceptor extends \Magento\Cookie\Block\Html\Notices implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, array $data = [], ?\Magento\Cookie\Helper\Cookie $cookieHelper = null)
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPrivacyPolicyLink');
        return $pluginInfo ? $this->___callPlugins('getPrivacyPolicyLink', func_get_args(), $pluginInfo) : parent::getPrivacyPolicyLink();
    }
