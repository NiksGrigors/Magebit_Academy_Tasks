...
class Interceptor extends \Magento\Catalog\Block\ShortcutButtons implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function addShortcut(\Magento\Framework\View\Element\Template $block)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addShortcut');
        return $pluginInfo ? $this->___callPlugins('addShortcut', func_get_args(), $pluginInfo) : parent::addShortcut($block);
    }
