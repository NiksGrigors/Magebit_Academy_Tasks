...
class Interceptor extends \Magento\Sales\Block\Order\Recent implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getViewUrl($order)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getViewUrl', func_get_args(), $pluginInfo) : parent::getViewUrl($order);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTrackUrl');
        return $pluginInfo ? $this->___callPlugins('getTrackUrl', func_get_args(), $pluginInfo) : parent::getTrackUrl($order);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getReorderUrl');
        return $pluginInfo ? $this->___callPlugins('getReorderUrl', func_get_args(), $pluginInfo) : parent::getReorderUrl($order);
    }
