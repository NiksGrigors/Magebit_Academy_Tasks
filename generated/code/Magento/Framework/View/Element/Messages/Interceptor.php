...
class Interceptor extends \Magento\Framework\View\Element\Messages implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMessages');
        return $pluginInfo ? $this->___callPlugins('setMessages', func_get_args(), $pluginInfo) : parent::setMessages($messages);
    }
    ...
    public function addMessages(\Magento\Framework\Message\Collection $messages)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addMessages', func_get_args(), $pluginInfo) : parent::addMessages($messages);
    }
    ...
    public function getMessageCollection()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getMessageCollection', func_get_args(), $pluginInfo) : parent::getMessageCollection();
    }
    ...
    public function addError($message)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addError', func_get_args(), $pluginInfo) : parent::addError($message);
    }
    ...
    public function addWarning($message)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addWarning', func_get_args(), $pluginInfo) : parent::addWarning($message);
    }
    ...
    public function addNotice($message)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addNotice', func_get_args(), $pluginInfo) : parent::addNotice($message);
    }
    ...
    public function addSuccess($message)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addSuccess', func_get_args(), $pluginInfo) : parent::addSuccess($message);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMessagesByType');
        return $pluginInfo ? $this->___callPlugins('getMessagesByType', func_get_args(), $pluginInfo) : parent::getMessagesByType($type);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMessageTypes');
        return $pluginInfo ? $this->___callPlugins('getMessageTypes', func_get_args(), $pluginInfo) : parent::getMessageTypes();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGroupedHtml');
        return $pluginInfo ? $this->___callPlugins('getGroupedHtml', func_get_args(), $pluginInfo) : parent::getGroupedHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setFirstLevelTagName');
        return $pluginInfo ? $this->___callPlugins('setFirstLevelTagName', func_get_args(), $pluginInfo) : parent::setFirstLevelTagName($tagName);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSecondLevelTagName');
        return $pluginInfo ? $this->___callPlugins('setSecondLevelTagName', func_get_args(), $pluginInfo) : parent::setSecondLevelTagName($tagName);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addStorageType');
        return $pluginInfo ? $this->___callPlugins('addStorageType', func_get_args(), $pluginInfo) : parent::addStorageType($type);
    }
