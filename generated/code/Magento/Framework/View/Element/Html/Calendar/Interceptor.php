...
class Interceptor extends \Magento\Framework\View\Element\Html\Calendar implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTimezoneOffsetSeconds');
        return $pluginInfo ? $this->___callPlugins('getTimezoneOffsetSeconds', func_get_args(), $pluginInfo) : parent::getTimezoneOffsetSeconds();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreTimestamp');
        return $pluginInfo ? $this->___callPlugins('getStoreTimestamp', func_get_args(), $pluginInfo) : parent::getStoreTimestamp($store);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getYearRange');
        return $pluginInfo ? $this->___callPlugins('getYearRange', func_get_args(), $pluginInfo) : parent::getYearRange();
    }
