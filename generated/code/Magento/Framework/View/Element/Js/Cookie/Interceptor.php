...
class Interceptor extends \Magento\Framework\View\Element\Js\Cookie implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDomain');
        return $pluginInfo ? $this->___callPlugins('getDomain', func_get_args(), $pluginInfo) : parent::getDomain();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLifetime');
        return $pluginInfo ? $this->___callPlugins('getLifetime', func_get_args(), $pluginInfo) : parent::getLifetime();
    }
