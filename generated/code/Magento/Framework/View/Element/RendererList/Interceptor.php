<?php
namespace Magento\Framework\View\Element\RendererList;

/**
 * Interceptor class for @see \Magento\Framework\View\Element\RendererList
 */
class Interceptor extends \Magento\Framework\View\Element\RendererList implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getRenderer($type, $default = null, $rendererTemplate = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getRenderer', func_get_args(), $pluginInfo) : parent::getRenderer($type, $default, $rendererTemplate);
    }
