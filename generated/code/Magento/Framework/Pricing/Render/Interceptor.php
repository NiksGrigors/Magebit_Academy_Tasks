...
class Interceptor extends \Magento\Framework\Pricing\Render implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function render($priceCode, \Magento\Framework\Pricing\SaleableInterface $saleableItem, array $arguments = [])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('render', func_get_args(), $pluginInfo) : parent::render($priceCode, $saleableItem, $arguments);
    }
    ...
    public function renderAmount(\Magento\Framework\Pricing\Amount\AmountInterface $amount, \Magento\Framework\Pricing\Price\PriceInterface $price, ?\Magento\Framework\Pricing\SaleableInterface $saleableItem = null, array $arguments = [])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('renderAmount', func_get_args(), $pluginInfo) : parent::renderAmount($amount, $price, $saleableItem, $arguments);
    }
