...
class Interceptor extends \Magento\Framework\Pricing\Render\RendererPool implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'createPriceRender');
        return $pluginInfo ? $this->___callPlugins('createPriceRender', func_get_args(), $pluginInfo) : parent::createPriceRender($priceCode, $saleableItem, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAdjustmentRenders');
        return $pluginInfo ? $this->___callPlugins('getAdjustmentRenders', func_get_args(), $pluginInfo) : parent::getAdjustmentRenders($saleableItem, $price);
    }
