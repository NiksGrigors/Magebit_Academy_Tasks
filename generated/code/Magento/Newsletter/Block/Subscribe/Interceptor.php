...
class Interceptor extends \Magento\Newsletter\Block\Subscribe implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormActionUrl');
        return $pluginInfo ? $this->___callPlugins('getFormActionUrl', func_get_args(), $pluginInfo) : parent::getFormActionUrl();
    }
