...
class Interceptor extends \Magento\Customer\Block\Adminhtml\Edit\Tab\View\Grid\Renderer\Item implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\Block\Context $context, \Magento\Catalog\Helper\Product\Configuration $productConfig, \Magento\Catalog\Helper\Product\ConfigurationPool $productConfigPool, array $data = [])
    {
        $this->___init();
