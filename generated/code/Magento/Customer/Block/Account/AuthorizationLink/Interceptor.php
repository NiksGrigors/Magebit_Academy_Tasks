...
class Interceptor extends \Magento\Customer\Block\Account\AuthorizationLink implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getHref()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getHref', func_get_args(), $pluginInfo) : parent::getHref();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPostParams');
        return $pluginInfo ? $this->___callPlugins('getPostParams', func_get_args(), $pluginInfo) : parent::getPostParams();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinkAttributes');
        return $pluginInfo ? $this->___callPlugins('getLinkAttributes', func_get_args(), $pluginInfo) : parent::getLinkAttributes();
    }
