...
class Interceptor extends \Magento\Customer\Block\Account\SortLink implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isCurrent');
        return $pluginInfo ? $this->___callPlugins('isCurrent', func_get_args(), $pluginInfo) : parent::isCurrent();
    }
