...
class Interceptor extends \Magento\Customer\Block\Account\Navigation implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setActive($path)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setActive', func_get_args(), $pluginInfo) : parent::setActive($path);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderLink');
        return $pluginInfo ? $this->___callPlugins('renderLink', func_get_args(), $pluginInfo) : parent::renderLink($link);
    }
