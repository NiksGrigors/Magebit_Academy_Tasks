...
class Interceptor extends \Magento\Customer\Block\Account\Customer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'customerLoggedIn');
        return $pluginInfo ? $this->___callPlugins('customerLoggedIn', func_get_args(), $pluginInfo) : parent::customerLoggedIn();
    }
