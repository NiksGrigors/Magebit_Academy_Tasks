...
class Interceptor extends \Magento\Theme\Block\Adminhtml\Design\Config\Edit\Scope implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getScopeTitle');
        return $pluginInfo ? $this->___callPlugins('getScopeTitle', func_get_args(), $pluginInfo) : parent::getScopeTitle();
    }
