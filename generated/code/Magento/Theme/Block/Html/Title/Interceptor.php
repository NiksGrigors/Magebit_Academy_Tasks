...
class Interceptor extends \Magento\Theme\Block\Html\Title implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setPageTitle');
        return $pluginInfo ? $this->___callPlugins('setPageTitle', func_get_args(), $pluginInfo) : parent::setPageTitle($pageTitle);
    }
