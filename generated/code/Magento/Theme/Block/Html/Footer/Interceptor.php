...
class Interceptor extends \Magento\Theme\Block\Html\Footer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMiscellaneousHtml');
        return $pluginInfo ? $this->___callPlugins('getMiscellaneousHtml', func_get_args(), $pluginInfo) : parent::getMiscellaneousHtml();
    }
