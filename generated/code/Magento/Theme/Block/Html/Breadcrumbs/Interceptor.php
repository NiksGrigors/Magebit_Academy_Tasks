...
class Interceptor extends \Magento\Theme\Block\Html\Breadcrumbs implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCrumbs');
        return $pluginInfo ? $this->___callPlugins('getCrumbs', func_get_args(), $pluginInfo) : parent::getCrumbs();
    }
