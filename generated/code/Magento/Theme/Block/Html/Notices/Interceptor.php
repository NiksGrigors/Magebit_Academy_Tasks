...
class Interceptor extends \Magento\Theme\Block\Html\Notices implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayNoscriptNotice');
        return $pluginInfo ? $this->___callPlugins('displayNoscriptNotice', func_get_args(), $pluginInfo) : parent::displayNoscriptNotice();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayNoLocalStorageNotice');
        return $pluginInfo ? $this->___callPlugins('displayNoLocalStorageNotice', func_get_args(), $pluginInfo) : parent::displayNoLocalStorageNotice();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayDemoNotice');
        return $pluginInfo ? $this->___callPlugins('displayDemoNotice', func_get_args(), $pluginInfo) : parent::displayDemoNotice();
    }
