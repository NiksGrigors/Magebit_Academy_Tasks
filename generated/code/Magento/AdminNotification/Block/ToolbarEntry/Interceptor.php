...
class Interceptor extends \Magento\AdminNotification\Block\ToolbarEntry implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNotificationDescriptionLength');
        return $pluginInfo ? $this->___callPlugins('getNotificationDescriptionLength', func_get_args(), $pluginInfo) : parent::getNotificationDescriptionLength();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNotificationCounterMax');
        return $pluginInfo ? $this->___callPlugins('getNotificationCounterMax', func_get_args(), $pluginInfo) : parent::getNotificationCounterMax();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUnreadNotificationCount');
        return $pluginInfo ? $this->___callPlugins('getUnreadNotificationCount', func_get_args(), $pluginInfo) : parent::getUnreadNotificationCount();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLatestUnreadNotifications');
        return $pluginInfo ? $this->___callPlugins('getLatestUnreadNotifications', func_get_args(), $pluginInfo) : parent::getLatestUnreadNotifications();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'formatNotificationDate');
        return $pluginInfo ? $this->___callPlugins('formatNotificationDate', func_get_args(), $pluginInfo) : parent::formatNotificationDate($dateString);
    }
