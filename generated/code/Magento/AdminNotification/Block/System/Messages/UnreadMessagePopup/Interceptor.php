...
class Interceptor extends \Magento\AdminNotification\Block\System\Messages\UnreadMessagePopup implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUnreadMessages');
        return $pluginInfo ? $this->___callPlugins('getUnreadMessages', func_get_args(), $pluginInfo) : parent::getUnreadMessages();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPopupTitle');
        return $pluginInfo ? $this->___callPlugins('getPopupTitle', func_get_args(), $pluginInfo) : parent::getPopupTitle();
    }

    /**
     * {@inheritdoc}
     */
    public function getItemClass(\Magento\Framework\Notification\MessageInterface $message)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemClass');
        return $pluginInfo ? $this->___callPlugins('getItemClass', func_get_args(), $pluginInfo) : parent::getItemClass($message);
    }
