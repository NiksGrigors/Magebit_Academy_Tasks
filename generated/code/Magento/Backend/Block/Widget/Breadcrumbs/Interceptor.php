...
class Interceptor extends \Magento\Backend\Block\Widget\Breadcrumbs implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addLink');
        return $pluginInfo ? $this->___callPlugins('addLink', func_get_args(), $pluginInfo) : parent::addLink($label, $title, $url);
    }
