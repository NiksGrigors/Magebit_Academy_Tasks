...
class Interceptor extends \Magento\Backend\Block\Page\Footer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMagentoVersion');
        return $pluginInfo ? $this->___callPlugins('getMagentoVersion', func_get_args(), $pluginInfo) : parent::getMagentoVersion();
    }
