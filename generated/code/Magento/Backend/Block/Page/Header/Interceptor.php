...
class Interceptor extends \Magento\Backend\Block\Page\Header implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHomeLink');
        return $pluginInfo ? $this->___callPlugins('getHomeLink', func_get_args(), $pluginInfo) : parent::getHomeLink();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLogoutLink');
        return $pluginInfo ? $this->___callPlugins('getLogoutLink', func_get_args(), $pluginInfo) : parent::getLogoutLink();
    }
