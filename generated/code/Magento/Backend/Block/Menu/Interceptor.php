...
class Interceptor extends \Magento\Backend\Block\Menu implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCacheLifetime()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCacheLifetime', func_get_args(), $pluginInfo) : parent::getCacheLifetime();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMenuModel');
        return $pluginInfo ? $this->___callPlugins('getMenuModel', func_get_args(), $pluginInfo) : parent::getMenuModel();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderMenu');
        return $pluginInfo ? $this->___callPlugins('renderMenu', func_get_args(), $pluginInfo) : parent::renderMenu($menu, $level);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getActiveItemModel');
        return $pluginInfo ? $this->___callPlugins('getActiveItemModel', func_get_args(), $pluginInfo) : parent::getActiveItemModel();
    }
