...
class Interceptor extends \Magento\Backend\Block\GlobalSearch implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWidgetInitOptions');
        return $pluginInfo ? $this->___callPlugins('getWidgetInitOptions', func_get_args(), $pluginInfo) : parent::getWidgetInitOptions();
    }
