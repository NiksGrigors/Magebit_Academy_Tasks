...
class Interceptor extends \Magento\AdobeStockAdminUi\Block\Adminhtml\System\Config\TestConnection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\AdobeStockClientApi\Api\ClientInterface $client, \Magento\AdobeImsApi\Api\ConfigInterface $config, \Magento\Backend\Block\Template\Context $context, array $data = [], ?\Magento\AdminAdobeIms\Service\ImsConfig $adminAdobeImsConfig = null)
    {
        $this->___init();
        parent::__construct($client, $config, $context, $data, $adminAdobeImsConfig);
    }
