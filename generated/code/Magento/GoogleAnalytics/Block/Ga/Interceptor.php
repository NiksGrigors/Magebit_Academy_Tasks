...
class Interceptor extends \Magento\GoogleAnalytics\Block\Ga implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPageName');
        return $pluginInfo ? $this->___callPlugins('getPageName', func_get_args(), $pluginInfo) : parent::getPageName();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPageTrackingCode');
        return $pluginInfo ? $this->___callPlugins('getPageTrackingCode', func_get_args(), $pluginInfo) : parent::getPageTrackingCode($accountId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrdersTrackingCode');
        return $pluginInfo ? $this->___callPlugins('getOrdersTrackingCode', func_get_args(), $pluginInfo) : parent::getOrdersTrackingCode();
    }
    ...
    public function isCookieRestrictionModeEnabled()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('isCookieRestrictionModeEnabled', func_get_args(), $pluginInfo) : parent::isCookieRestrictionModeEnabled();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentWebsiteId');
        return $pluginInfo ? $this->___callPlugins('getCurrentWebsiteId', func_get_args(), $pluginInfo) : parent::getCurrentWebsiteId();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPageTrackingData');
        return $pluginInfo ? $this->___callPlugins('getPageTrackingData', func_get_args(), $pluginInfo) : parent::getPageTrackingData($accountId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrdersTrackingData');
        return $pluginInfo ? $this->___callPlugins('getOrdersTrackingData', func_get_args(), $pluginInfo) : parent::getOrdersTrackingData();
    }
