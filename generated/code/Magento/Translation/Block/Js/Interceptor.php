...
class Interceptor extends \Magento\Translation\Block\Js implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'dictionaryEnabled');
        return $pluginInfo ? $this->___callPlugins('dictionaryEnabled', func_get_args(), $pluginInfo) : parent::dictionaryEnabled();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTranslationFileTimestamp');
        return $pluginInfo ? $this->___callPlugins('getTranslationFileTimestamp', func_get_args(), $pluginInfo) : parent::getTranslationFileTimestamp();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTranslationFilePath');
        return $pluginInfo ? $this->___callPlugins('getTranslationFilePath', func_get_args(), $pluginInfo) : parent::getTranslationFilePath();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTranslationFileVersion');
        return $pluginInfo ? $this->___callPlugins('getTranslationFileVersion', func_get_args(), $pluginInfo) : parent::getTranslationFileVersion();
    }
