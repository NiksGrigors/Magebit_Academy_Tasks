...
class Interceptor extends \Mollie\Payment\GraphQL\Resolver\Cart\AvailableTerminalsForMethod implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Mollie\Payment\Service\Mollie\PointOfSaleAvailability $pointOfSaleAvailability, \Mollie\Payment\Service\Mollie\AvailableTerminals $availableTerminals)
    {
        $this->___init();
        parent::__construct($pointOfSaleAvailability, $availableTerminals);
    }
